...
CREATE TABLE `mt_merchant` (
  ...
  `OPERATOR` varchar(30) DEFAULT '' COMMENT '最后操作人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='商户表'
...
insert  into `mt_store`(`ID`,`MERCHANT_ID`,`NAME`,`IS_DEFAULT`,`CONTACT`,`WX_MCH_ID`,`WX_API_V2`,`PHONE`,`ADDRESS`,`LATITUDE`,`LONGITUDE`,`DISTANCE`,`HOURS`,`DESCRIPTION`,`CREATE_TIME`,`UPDATE_TIME`,`STATUS`,`OPERATOR`) values 
(1,0,'海口国兴路店','Y','王五','','','18976679980','海口市人民北路113号11','20.02971','110.32942',0.00,'9:00-22:0','默认店铺','2022-01-14 11:19:32','2023-03-19 21:51:36','N','fuint');
...
(1,1,'普通会员','默认取得','init',0,'基础会员',0,9.50,1.00,'A');
...
insert  into `t_account`(`acct_id`,`account_key`,`account_name`,`password`,`account_status`,`is_active`,`create_date`,`modify_date`,`salt`,`role_ids`,`locked`,`owner_id`,`real_name`,`store_id`,`store_name`,`staff_id`) values 
(1,'20160714677851484251776','fuint','058208c3e693a8ac1bfa50c48367f09b587de668',1,1,'2019-10-25 15:54:17','2023-03-11 14:32:22','6734e249975e587c','2',0,NULL,'管理员',0,'海口人民路店',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=9694 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';
